...
class Sphere:
    ...
    # The "geometric" way of calculating the intersection between the sphere and a ray.
    ...
    def intersect(self, ray):
        ...
        l2oc = oc.dot(oc)
        outside = l2oc > self.square_radius
